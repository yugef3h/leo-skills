...
| [**SOP Design**](./skills/sop-design/) | Spec + Harness 双支柱 AI 辅助开发流程：文档先行、TDD/SDD、代码审查、AGENTS.md 三次原则维护，集成 BDD/Conventional Commits/Testing Trophy | `npx skills add yugef3h/leo-skills --path skills/sop-design` |
